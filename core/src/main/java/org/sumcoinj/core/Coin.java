...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    public static final Coin ONEHUNDRED_COINS = COIN.multiply(100);
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.SUM.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.SUM.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in SUM.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" SUM
     * </p>
     */
