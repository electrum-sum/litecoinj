...
public class BlockChainTest {
    ...
    public void coinbaseTransactionAvailability() throws Exception {
        ...
        assertEquals(Coin.ZERO, wallet.getBalance());
        assertEquals(wallet.getBalance(BalanceType.ESTIMATED), ONEHUNDRED_COINS);
        ...
        assertEquals(wallet.getBalance(), ONEHUNDRED_COINS);
        assertEquals(wallet.getBalance(BalanceType.ESTIMATED), ONEHUNDRED_COINS);
        assertTrue(coinbaseTransaction.isMature());

        // Create a spend with the coinbase SUM to the address in the second wallet - this should now succeed.
