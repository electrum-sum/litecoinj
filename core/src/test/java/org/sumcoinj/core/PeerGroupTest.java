...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        for (ECKey key1 : keys) {
            ...
            Block next = FakeTxBuilder.makeSolvedTestBlock(prev, FakeTxBuilder.createFakeTx(PARAMS, Coin.ONEHUNDRED_COINS, addr));
        ...
        assertEquals(Coin.ONEHUNDRED_COINS.multiply(3), wallet.getBalance());
