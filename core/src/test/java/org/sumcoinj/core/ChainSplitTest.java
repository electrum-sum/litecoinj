...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        assertEquals(ONEHUNDRED_COINS, wallet.getBalance());
    ...
    public void testForking4() throws Exception {
        ...
        assertEquals(ONEHUNDRED_COINS, wallet.getBalance());
        Address dest = new ECKey().toAddress(PARAMS);
        Transaction spend = wallet.createSend(dest, ONEHUNDRED_COINS);
    ...
    public void coinbaseDeath() throws Exception {
        ...
        // ... and spend.
        Transaction fodder = wallet.createSend(new ECKey().toAddress(PARAMS), ONEHUNDRED_COINS);
